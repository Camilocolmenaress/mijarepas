...
export default function ConfirmacionPage() {
  ...
  return (
    /* ── Cambio 5: fondo imagen ilustracion-confirmacion.jpeg + overlay fucsia 88% ── */
    <div
      style={{
        minHeight: '100dvh',
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            style={{ fontSize: '5.5rem', lineHeight: 1, filter: 'drop-shadow(0 4px 16px rgba(0,0,0,0.3))' }}
          >
            ✅
          </motion.div>
