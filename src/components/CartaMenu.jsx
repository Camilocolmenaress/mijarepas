    ...
    <>
      ...
      >
        <div style={{ flex: 1, minWidth: 0 }}>
          <p className="font-brinnan-black" style={{ color: nombreColor, fontSize: nombreSize, lineHeight: 1.2, marginBottom: '2px', textShadow: contorno(nombreColor), textTransform: 'uppercase', letterSpacing: '1.5px' }}>
            {producto.nombre}
          </p>
          {producto.desc ? (
...
function SubTitulo({ texto, color, size = '24px', fontClass = 'font-brinnan-black' }) {
  return (
...
function CheckboxIngrediente({ nombre, precio, checked, disabled, onToggle, colorText, colorCheck, colorDis }) {
  return (
    ...
    >
      ...
      <span className="font-brinnan-black" style={{ color: colorText, fontSize: '1.3rem', lineHeight: 1.2, flex: 1, textShadow: contorno(colorText), textTransform: 'uppercase', letterSpacing: '1.5px' }}>
        {nombre}
      </span>
    </div>
  )
...
function SeccionDesgranados() {
  ...
  return (
    <div style={{ background: '#E12B4E', minWidth: '100vw', overflowY: 'auto', scrollSnapAlign: 'start', paddingBottom: '220px' }}>
      <img src="/images/titulo-desgranados.png" alt="Los Desgranados más Amados" style={{ width: '100%', display: 'block', margin: 0, padding: 0, borderRadius: '12px', border: '3px solid #f9ac31' }} />
...
function SeccionParrilla() {
  ...
  return (
    <div style={{ background: '#E12B4E', minWidth: '100vw', overflowY: 'auto', scrollSnapAlign: 'start', paddingBottom: '220px' }}>
      <img src="/images/titulo-parrilladas.png" alt="Las Parrilladas más Esperadas" style={{ width: '100%', display: 'block', margin: 0, padding: 0, borderRadius: '12px', border: '3px solid #f9ac31' }} />
      <div style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 20px', margin: 0, marginTop: '-20px' }}>
...
function FilaProductoBebida({ producto, onOpenModal, nombreColor = '#FFFFFF', precioColor = '#FFFFFF', descColor = '#FFFFFF', btnBg = '#f9ac31', btnColor = '#42261a', sepColor = 'rgba(255,255,255,0.3)' }) {
  ...
  return (
    <>
      ...
      >
        <div style={{ flex: 1, minWidth: 0 }}>
          <p className="font-brinnan-black" style={{ color: nombreColor, fontSize: '1.3rem', lineHeight: 1.2, marginBottom: '2px', textShadow: contorno(nombreColor), textTransform: 'uppercase', letterSpacing: '1.5px' }}>
            {producto.nombre}
          </p>
          {producto.desc ? (
            <p className="font-brinnan" style={{ color: descColor, opacity: 0.7, fontSize: '13px', lineHeight: 1.4 }}>
...
function FilaProductoAdicional({ producto }) {
  ...
  return (
    <>
      ...
      >
        <p className="font-brinnan-black" style={{ color: '#f9ac31', fontSize: '1.3rem', lineHeight: 1.2, textShadow: contorno('#f9ac31'), textTransform: 'uppercase', letterSpacing: '1.5px' }}>
          {producto.nombre}
        </p>
...
function SeccionAdicionales() {
  ...
  return (
    <div style={{ background: '#E12B4E', minWidth: '100vw', overflowY: 'auto', scrollSnapAlign: 'start', padding: '0px 20px 220px' }}>
